  ...
  <div id="login">
    ...
    <el-row class="main-container">
      <el-col :lg="8" :xs="16" :md="10" :span="10">
        <div class="top">
          <i class="iconfont icon-kaoshi"></i><span class="title">四六级考试系统</span>
        </div>
        <div class="bottom">
          <div class="container">
    ...
    <el-row class="footer">
      <el-col>
        <p class="msg2">版权所有 ©2019 <!--济南大学泉城学院吉曼曼--> 保留所有权利 沪ICP备19001371号</p>
      </el-col>
    </el-row>
...
#login .bg {
  ...
  overflow-y: auto;
  height: 100%;
  background: url('../../assets/img/bgcolor.png')center top / cover no-repeat;
